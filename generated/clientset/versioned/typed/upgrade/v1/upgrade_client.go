...
import (
	...
	"github.com/arshukla98/sample-controller/generated/clientset/versioned/scheme"
...
// UpgradeV1Client is used to interact with features provided by the upgrade.k8s.io group.
type UpgradeV1Client struct {
	restClient rest.Interface
}

func (c *UpgradeV1Client) UpgradeKubes(namespace string) UpgradeKubeInterface {
	return newUpgradeKubes(c, namespace)
}
